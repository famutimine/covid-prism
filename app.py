...
This artificial intelligence-based prognostic tool has been internally validated to predict 24-48 hour inpatient mortality risk with an area under the receiver operating characteristic curve (AUROC) of 0.93, sensitivity of 95% and specificity of 75%.''')

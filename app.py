...
covid_df=covid_df.rename({"SpO2_FiO2_Ratio":"SpO2:FiO2 Ratio", "BUN":"Blood Urea Nitrogen","Respiratory_Rate":"Respiratory Rate","HGB":"Hemoglobin","Heart_Rate":"Heart Rate","SBP":"Systolic Blood Pressure"},axis=1,inplace = True)
X = covid_df.iloc[:, :-1]
Y = covid_df.iloc[:, -1:]
model=XGBClassifier()
model.fit(X, Y)

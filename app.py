...
def user_input_features():
    input_features = {}
    input_features["Albumin"] = st.text_input(label='Serum Albumin (g/L)', value="", max_chars=3, help="Leave blank if value is missing")
    input_features["Blood Urea Nitrogen"] = st.text_input(label='Blood Urea Nitrogen (mg/dL)', value="",max_chars=4, help="Leave blank if value is missing") 
    ...
    input_features["Hemoglobin"] = st.text_input(label='Hemoglobin Level (g/dL)', value="",max_chars=3, help="Leave blank if value is missing")

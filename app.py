...
if submit:
    ...
    fig, ax = plt.subplots()
    shap.plots.waterfall(explainer.expected_value,shap_values,feature_names=feature_names)
    ...
    shap.plots.waterfall(explainer7.expected_value,shap_values7,feature_names=feature_names)

...
if submit:
    ...
    fig, ax = plt.subplots()
    shap.waterfall_plot(explainer.expected_value,shap_values,feature_names=feature_names)
    ...
    shap.waterfall_plot(explainer7.expected_value,shap_values7,feature_names=feature_names)
